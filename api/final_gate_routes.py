...
def run_release_gate(body: ReleaseGateIn) -> dict:
    return release_gate(core_path=body.core_path, result_path=body.result_path, route_key=body.route_key, run_tests=body.run_tests, verify_bytes=body.verify_bytes)
